...
const config = {
    ...
    aktif: '21 DEC',
    youtube: '',
    whatsapp: 'https://wa.me+5516988466655',
      ...
      case 'info':
       ...
       case 'ytmp4':
           ytdl('mp4', value)
               .then(data => {
                   const { judul, size, hasil: link } = data
                   let hasil = `AQUI ESTÁ O LINK DE DOWNLOAD DA MSC\nCLIQUE NO LINK ABAIXO:\nMUSICA: ${judul}\n\nTamaño De audio: ${size}\n\nLink: ${link}`
                   client.sendMessage(id, '[ESPERE UM MOMENTO...', MessageType.text)
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
       ...
       case 'twt':
           tweetdl(value)
               .then(data => {
                    ...
                    let hasil = `✄1�71ￄ1�77 PERFEITO! Eliga su metodo de descarga!\nKlik link dibawah🗡️\n\nSize: ${size}\n\nLink: ${link}`
                    client.sendMessage(id, '[ESPERE UM MOMENTO...', MessageType.text)
                    client.sendMessage(id, hasil ,MessageType.text)
               })
               .catch(err => {
